...
const MyComponent = () => (
   <View style={styles.root}>
    <View style={styles.item1}>
      ...
      <Text style={{fontSize: normalize(45), opacity: 0.6}}>15</Text>
    ...
    <View style={styles.item2}>
      ...
      <Text style={{fontSize: normalize(35), textAlign: 'right', marginVertical: 5, opacity: 0.6}}>24th Aug</Text>
      <Text style={{fontSize: normalize(20), textAlign: 'right', opacity: 0.6}}>11:55 PM</Text>
    </View>
  </View>
 );
